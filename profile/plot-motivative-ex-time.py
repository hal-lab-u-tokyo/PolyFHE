...
ax.axis('equal')
plt.savefig(f"{directory_path}/profile/figure/motivative-ex-time.eps", dpi=500, bbox_inches='tight', pad_inches=0)
plt.savefig(f"{directory_path}/profile/figure/motivative-ex-time.png", dpi=500, bbox_inches='tight', pad_inches=0)
