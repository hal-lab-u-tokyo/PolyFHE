...
bconv_ax = pf.bconv_general(moddown_scale_ax, f"BConv_ax", prm.L, prm.L + prm.K, 0, prm.L + prm.K)
bconv_bx = pf.bconv_general(moddown_scale_bx, f"BConv_bx", prm.L, prm.L + prm.K, 0, prm.L + prm.K)
