...
METRICS="l1tex__t_sector_hit_rate,lts__t_sector_hit_rate,dram__bytes_read.sum,dram__bytes_write.sum,lts__t_sectors_op_write.sum,lts__t_sectors_op_read.sum"
...
for NUM_DIVIDES in ${NUM_DIVIDES_LIST[@]}; do
    ...
    ncu --csv --import cachehit.ncu-rep > data/ncu-memory-accum-v7-wrong-${NUM_DIVIDES}.csv
done
