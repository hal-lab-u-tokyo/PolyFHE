...
inttp2 = pf.ntt(mult_bxbx,"iNTTP2",if_forward=False,if_phase1=False,start_limb=0,end_limb=prm.L, exclude_start=0,exclude_end=0,)
inttp1 = pf.ntt(inttp2,"iNTTP1",if_forward=False,if_phase1=True,start_limb=0,end_limb=prm.L,exclude_start=0,exclude_end=0,)
...
for beta_idx in range(prm.get_beta(prm.L - 1)):
    ...
    nttp1_after_bconv = pf.ntt(bconv,f"NTTP1{beta_idx}",if_forward=True,if_phase1=True,start_limb=0,end_limb=prm.L + prm.K,exclude_start=prm.alpha * beta_idx,
