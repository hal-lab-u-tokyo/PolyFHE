...
void TestScheme::testConjugateBatch(long logN, long L, long logp,
                                    long logSlots) {
...
void TestScheme::testRotateByPo2Batch(long logN, long L, long logp,
                                      long logRotSlots, long logSlots,
                                      bool isLeft) {
...
void TestScheme::testRotateBatch(long logN, long L, long logp, long rotSlots,
...
void TestScheme::testPowerOf2Batch(long logN, long L, long logp, long logDegree,
                                   long logSlots) {
...
void TestScheme::testPowerBatch(long logN, long L, long logp, long degree,
                                long logSlots) {
...
void TestScheme::testProdOfPo2Batch(long logN, long L, long logp,
                                    long logDegree, long logSlots) {
...
void TestScheme::testProdBatch(long logN, long L, long logp, long degree,
                               long logSlots) {
...
void TestScheme::testInverseBatch(long logN, long L, long logp, long invSteps,
                                  long logSlots) {
...
void TestScheme::testLogarithmBatch(long logN, long L, long logp, long degree,
                                    long logSlots) {
...
void TestScheme::testExponentBatch(long logN, long L, long logp, long degree,
                                   long logSlots) {
...
void TestScheme::testSigmoidBatch(long logN, long L, long logp, long degree,
                                  long logSlots) {
