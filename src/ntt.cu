...
void nwt_2d_radix8_forward_inplace(uint64_t* inout, const DNTTTable& ntt_tables,
    ...
    /*
        ...
        inplace_fnwt_radix8_phase2<<<gridDimNTT, blockDimNTT,
       per_block_memory>>>( inout, ntt_tables.twiddle(),
       ntt_tables.twiddle_shoup(), ntt_tables.modulus(), coeff_modulus_size,
       start_modulus_idx, poly_degree, phase1_sample_size, phase2_sample_size);
    */
}
