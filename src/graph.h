...
typedef boost::adjacency_list<boost::listS, boost::vecS, boost::bidirectionalS, PolyOp> GraphPoly;
typedef boost::adjacency_list<boost::listS, boost::vecS, boost::bidirectionalS, FHEOp> GraphFHE;
